...
<body>
	<table class="altrowstable" id="alternatecolor" align="center">
		...
		<tr class="row<%=i % 2 + 1%>">
			...
			<td><p>
					<a href="Delstudnet.do?id=<%=s.getStudentid()%>">删除</a>
				</p>
			</td>
			<td><p>
					<a href="loadStudnet.do?id=<%=s.getStudentid()%>">修改</a>
				</p>
			</td>
		</tr>
		<%
		...
		%>
		<tr><td><a href="admin/addStudent.jsp">增加学生</a></td></tr>
		 <tr><td><a href="admin/admin.jsp">返回操作主界面</a></td></tr> 
		 <tr><td><a href="showclass.do">图表显示</a></td></tr> 
	</table>
</body>
</html>
